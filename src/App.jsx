...
export default function App() {
  ...
  useEffect(()=>{
    fetch(`https://random-word-api.herokuapp.com/word?length=${Math.floor(Math.random()*4)+3}&diff=1`)
    .then((value)=>value.json())
    .then((data)=>(setCurrentWord(data[0].toLowerCase())))
  },[])
  ...
  {
    await fetch(`https://random-word-api.herokuapp.com/word?length=${Math.floor(Math.random()*4)+3}&diff=1`)
    .then((value)=>value.json())
